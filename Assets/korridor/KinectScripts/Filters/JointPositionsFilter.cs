...
public class JointPositionsFilter
{
    ...
    public void UpdateFilter(KinectWrapper.NuiSkeletonData skeleton)
    {
//        if (null == skeleton)
//        {
//            return;
//        }
        ...
        for(int jointIndex = 0; jointIndex < jointsCount; jointIndex++)
        {
            ...
            FilterJoint(skeleton, jointIndex, tempSmoothingParams);
        }
    }

    // Update the filter for one joint.  
    protected void FilterJoint(KinectWrapper.NuiSkeletonData skeleton, int jointIndex, KinectWrapper.NuiTransformSmoothParameters smoothingParameters)
    {
//        if (null == skeleton)
//        {
//            return;
