...
//        }
        ...
        for(int jointIndex = 0; jointIndex < jointsCount; jointIndex++)
        {
            ...
            FilterJoint(ref skeleton, jointIndex, tempSmoothingParams, ref jointOrientations);
        }
    }

    // Update the filter for one joint.  
    protected void FilterJoint(ref KinectWrapper.NuiSkeletonData skeleton, int jointIndex, KinectWrapper.NuiTransformSmoothParameters smoothingParameters, ref Matrix4x4[] jointOrientations)
    {
//        if (null == skeleton)
//        {
//            return;
